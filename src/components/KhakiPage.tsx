  ...
  return (
    <div className="pt-32 pb-24 bg-slate-50 min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-40">
        <div className="absolute top-[10%] left-[20%] w-[500px] h-[500px] rounded-full bg-brand-blue/10 blur-[150px] animate-pulse" />
        <div className="absolute top-[60%] right-[10%] w-[600px] h-[600px] rounded-full bg-brand-blue/5 blur-[150px]" />
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <motion.h1
            ...
            className="font-display text-5xl md:text-7xl text-slate-900 mb-4 leading-tight"
          >
            Syed Rasool Shah <span className="text-brand-blue italic">Khaki</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.3 }}
            className="font-arabic text-2xl text-slate-500 tracking-wider mb-2"
          >
            سید رسول شاہ خاکی رحمۃ اللہ علیہ
          </motion.p>
          <p className="text-xs uppercase tracking-[3px] text-brand-blue font-semibold">
            Father of Makhdoom Mahmood Mastwaar Qalandar
          </p>
          <div className="h-1 w-24 bg-gradient-to-r from-brand-blue via-blue-500 to-blue-300 mx-auto mt-8 rounded-full" />
        </div>
        ...
        <motion.div
          ...
          className="bg-white p-8 md:p-16 rounded-[40px] border border-slate-100 shadow-xl relative"
        >
          {/* Decorative Corner Ornaments */}
          <div className="absolute top-6 left-6 text-brand-blue/30 hidden sm:block">
            <Feather size={24} />
          </div>
          <div className="absolute top-6 right-6 text-brand-blue/30 hidden sm:block">
            <BookOpen size={24} />
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-start mb-16">
              <div className="flex-1 font-serif text-lg leading-relaxed text-slate-700">
                <p className="mb-6">
                  <span className="float-left text-7xl font-display text-brand-blue pr-4 pb-2 leading-none">
                    S
                  </span>
              ...
              <div className="w-full lg:w-80 shrink-0">
                <div className="bg-slate-50 p-3 rounded-3xl border border-slate-200 shadow-md overflow-hidden group">
                  <img
            ...
            <div className="h-[1px] bg-gradient-to-r from-transparent via-slate-200 to-transparent my-12" />

            {/* State of Jazb & Travels */}
            <div className="mb-16">
              <h2 className="font-display text-3xl text-slate-900 mb-6 italic">
            ...
            <div className="mb-16 font-serif text-lg leading-relaxed text-slate-700">
              <h2 className="font-display text-3xl text-slate-900 mb-6 italic text-center">
                Literary Contributions & The Divine Vision
              </h2>
              <p className="mb-6 text-center max-w-3xl mx-auto">
                Syed Rasool Shah Khaki was also a prolific writer on the subject of Tasawwuf, contributing significantly to the literature of Sufism. His works include <strong className="text-brand-blue font-normal italic">Misbahul Hidayat</strong>, <strong className="text-brand-blue font-normal italic">Asrar e Ramooz e Tareeqat</strong>, <strong className="text-brand-blue font-normal italic">Ramooz e Haqeeqat</strong>, <strong className="text-brand-blue font-normal italic">Zia ul Quloob</strong> and <strong className="text-brand-blue font-normal italic">Kashkol e Qalandari Dar Daman e Sikandari</strong>, each of which reflects his deep spiritual insights and commitment to the Sufi path.
              </p>

              <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-sm my-8 text-center max-w-3xl mx-auto">
                <p className="text-sm font-sans tracking-widest text-brand-blue uppercase font-bold mb-3">
                  Transformation of Makhdum Pur Sharif
                </p>
                <p className="italic text-base text-slate-600 leading-relaxed">
            ...
            <div className="mt-16 pt-12 border-t border-slate-200 text-center">
              <h3 className="font-display text-2xl text-slate-900 mb-8 tracking-wide">
                Enduring Legacy & Sacred Sayings
              </h3>
              
              <div className="space-y-8 max-w-3xl mx-auto">
                <blockquote className="bg-slate-50 p-8 rounded-3xl border-l-4 border-l-brand-blue text-left shadow-sm">
                  <p className="font-serif italic text-xl text-slate-900 leading-relaxed mb-4">
                    “To contemplate is Noor (The Light) whereas neglect is darkness, and ignorance is misguidance.”
                  </p>
                  <footer className="text-xs uppercase tracking-widest text-brand-blue font-bold">
                    — Syed Rasool Shah Khaki (رحمۃ اللہ علیہ)
                  </footer>
                </blockquote>
