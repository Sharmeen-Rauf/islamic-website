  ...
  return (
    <div className="pt-32 pb-24 bg-slate-950 min-h-screen relative overflow-hidden text-slate-300">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-25">
        <div className="absolute top-[20%] left-[15%] w-[500px] h-[500px] rounded-full bg-brand-green/20 blur-[150px]" />
        <div className="absolute bottom-[10%] right-[20%] w-[400px] h-[400px] rounded-full bg-brand-blue/20 blur-[150px]" />
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <motion.div
          ...
          className="glass-dark p-8 md:p-14 rounded-[40px] border border-brand-green/20 mb-16 shadow-2xl relative"
        >
          <div className="flex flex-col md:flex-row items-start justify-between gap-6 mb-8 pb-8 border-b border-white/10">
            <div>
            ...
            <div className="glass px-6 py-3 rounded-2xl text-xs uppercase tracking-widest text-brand-gold font-bold flex items-center gap-2">
              <Sparkles size={16} /> Founded Feb 18, 2018
            </div>
          </div>

          <div className="space-y-6 font-serif text-lg leading-relaxed text-slate-300">
            <p>
          ...
          <div className="my-10 p-8 glass rounded-3xl border border-white/10 bg-gradient-to-r from-brand-green/10 to-transparent">
          ...
          <p className="font-serif text-lg leading-relaxed text-slate-300 mb-8">
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a 
              ...
              className="px-8 py-4 bg-brand-green text-black rounded-full text-xs uppercase tracking-widest font-bold hover:scale-105 transition-all flex items-center gap-3 shadow-lg shadow-brand-green/20"
            >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="glass-dark p-8 md:p-14 rounded-[40px] border border-brand-blue/20 shadow-2xl relative bg-gradient-to-br from-slate-900/50 via-slate-900/30 to-brand-blue/5"
        >
          <div className="flex flex-col md:flex-row items-start justify-between gap-6 mb-8 pb-8 border-b border-white/10">
            <div>
            ...
            <div className="glass px-6 py-3 rounded-2xl text-xs uppercase tracking-widest text-slate-300 font-bold">
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a 
              ...
              className="px-8 py-4 bg-brand-blue text-black rounded-full text-xs uppercase tracking-widest font-bold hover:scale-105 transition-all flex items-center gap-3 shadow-lg shadow-brand-blue/20"
            >
