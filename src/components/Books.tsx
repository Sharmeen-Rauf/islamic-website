...
const books = [
  { urdu: 'تفسیر مستوار', eng: 'Tafseer-e-Mastwaar', desc: 'Quranic Insights' },
  { urdu: 'مکین دل', eng: 'Makeen-e-Dil', desc: 'Dweller of the Heart' },
  { urdu: 'اسرار مستوار', eng: 'Asrar-e-Mastwaar', desc: 'Mysteries of Mastwaar' },
  { urdu: 'اذان قلندر', eng: 'Azan-e-Qalandar', desc: 'Poetry Collection' },
  { urdu: 'مقام محمود', eng: 'Maqam-e-Mahmood', desc: 'Divine Love Poetry' },
  { urdu: 'سلسلہ دلبر', eng: 'Silsala-e-Dilbar', desc: 'Tasawwuf Guide' },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {books.map((book, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative p-8 glass-dark rounded-3xl border border-white/5 hover:border-brand-gold/30 transition-all cursor-pointer overflow-hidden"
            >
