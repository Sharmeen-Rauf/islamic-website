  ...
  return (
    <div className="pt-32 pb-24 bg-slate-950 min-h-screen relative overflow-hidden text-slate-300">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-25">
        ...
        <div className="absolute bottom-[20%] right-[10%] w-[600px] h-[600px] rounded-full bg-brand-blue/20 blur-[150px]" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          >
            Welfare & <span className="text-gradient-pink">Social Service</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <p className="text-xs uppercase tracking-widest text-brand-gold font-bold mt-3">
        ...
        <motion.div
          ...
          className="glass-dark p-8 md:p-12 rounded-[40px] border border-white/10 mb-16 shadow-2xl bg-gradient-to-r from-brand-pink/5 via-transparent to-brand-blue/5"
        >
          <div className="max-w-4xl mx-auto text-center space-y-6 font-serif text-lg leading-relaxed text-slate-300">
            <p>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <span className="text-[10px] uppercase tracking-[4px] text-brand-gold font-bold">Initiatives</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((s, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="glass p-8 rounded-3xl border border-white/5 hover:border-brand-pink/30 transition-all flex flex-col justify-between group overflow-hidden relative"
              >
                <div className="absolute -top-12 -right-12 w-32 h-32 bg-white/5 rounded-full blur-2xl group-hover:bg-brand-pink/10 transition-colors" />

                <div>
                  <div className={`w-12 h-12 rounded-2xl bg-${s.color}/10 flex items-center justify-center text-${s.color} mb-6 group-hover:scale-110 transition-transform duration-500`}>
                    {s.icon}
                  </div>
                  <h3 className="font-display text-xl text-white mb-4 tracking-wide group-hover:text-brand-pink transition-colors">
                    {s.title}
                  </h3>
                ...
                <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
                  <span className="text-[10px] uppercase tracking-widest text-slate-500 group-hover:text-slate-300 transition-colors">Muhabbat Mission</span>
                  <div className="w-4 h-1 rounded-full bg-brand-pink group-hover:w-8 transition-all" />
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="glass p-12 rounded-[40px] border border-brand-pink/30 text-center relative overflow-hidden bg-gradient-to-b from-brand-pink/10 to-transparent shadow-2xl"
        >
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="pt-6">
              <a 
                href="#contact" 
                className="inline-flex items-center gap-3 px-10 py-4 rounded-full bg-brand-pink text-white font-bold text-xs uppercase tracking-widest hover:scale-105 transition-all shadow-xl shadow-brand-pink/30"
              >
