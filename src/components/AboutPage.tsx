  ...
  return (
    <div className="pt-32 pb-24 bg-slate-50 min-h-screen relative overflow-hidden text-slate-600">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-30">
        <div className="absolute top-[15%] left-[10%] w-[400px] h-[400px] rounded-full bg-brand-blue/10 blur-[140px]" />
        <div className="absolute bottom-[20%] right-[10%] w-[500px] h-[500px] rounded-full bg-brand-blue/5 blur-[150px]" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          <motion.span
            ...
            className="inline-block bg-white shadow-sm px-6 py-2 rounded-full text-xs uppercase tracking-[4px] text-brand-blue font-bold mb-6 border border-brand-blue/20"
          >
          ...
          >
            About <span className="text-brand-blue italic">Us</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <motion.div
          ...
          className="bg-white p-8 md:p-12 rounded-[40px] border border-slate-100 mb-16 shadow-xl relative overflow-hidden"
        >
          <div className="absolute -top-24 -right-24 w-72 h-72 bg-brand-blue/10 rounded-full blur-3xl pointer-events-none" />
          
          <span className="text-[10px] uppercase tracking-[4px] text-brand-blue font-bold">Introduction</span>
          <h2 className="font-display text-3xl md:text-4xl text-slate-900 mt-3 mb-6">
            Who is Makhdoom Mahmood Mastwaar Qalandar?
          </h2>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mt-8">
            <div className="lg:col-span-8 space-y-6 font-serif text-lg leading-relaxed text-slate-700">
              <p>
            ...
            <div className="lg:col-span-4 bg-slate-50 p-6 rounded-3xl border border-brand-blue/20 text-center shadow-md">
              <img 
              ...
              <p className="font-serif italic text-xs text-brand-blue">
          ...
          {/* Golden Quote */}
          <div className="mt-12 p-8 bg-slate-50 rounded-3xl border-l-4 border-l-brand-blue text-left bg-gradient-to-r from-brand-blue/5 to-transparent shadow-sm">
            <p className="font-serif italic text-lg md:text-xl text-slate-900 mb-3">
              "O Seeker of Truth! Become so madly in love that every part of your being begins to reflect the image of your Beloved."
            </p>
            <p className="font-arabic text-md text-brand-blue tracking-wide">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white p-8 md:p-12 rounded-[40px] border border-slate-100 shadow-xl flex flex-col justify-between"
          >
            <div>
              <span className="text-[10px] uppercase tracking-[4px] text-brand-blue font-bold">Biography</span>
              <h3 className="font-display text-2xl md:text-3xl text-slate-900 mt-3 mb-6">
                Makhdoom Mahmood Mastwaar Qalandar
              </h3>
              <div className="space-y-4 font-serif text-sm md:text-base leading-relaxed text-slate-700">
                <p>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="bg-white p-8 md:p-12 rounded-[40px] border border-brand-blue/20 flex flex-col justify-between bg-gradient-to-br from-white to-brand-blue/5 shadow-xl"
          >
            <div>
              <span className="text-[10px] uppercase tracking-[4px] text-brand-blue font-bold">Lineage Core</span>
              <h3 className="font-display text-2xl md:text-3xl text-slate-900 mt-3 mb-6">
                Syed Rasool Shah Khaki (رحمۃ اللہ علیہ)
              </h3>
              <div className="space-y-4 font-serif text-sm md:text-base leading-relaxed text-slate-700 mb-8">
                <p>
            ...
            <button
              ...
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-brand-blue text-white font-bold text-xs uppercase tracking-widest hover:bg-blue-700 transition-all w-fit shadow-xl"
            >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white p-8 md:p-12 rounded-[40px] border border-slate-100 shadow-xl mb-16 relative"
        >
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-10">
            <div>
              <span className="text-[10px] uppercase tracking-[4px] text-brand-blue font-bold">Oceans of Wisdom</span>
            ...
            <button
              ...
              className="px-8 py-3 bg-slate-50 border border-brand-blue/30 text-brand-blue hover:bg-brand-blue hover:text-white transition-all text-xs uppercase tracking-widest font-bold flex items-center gap-2 rounded-full shadow-sm"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {booksList.map((b, i) => (
              <div 
                key={i}
                onClick={() => onNavigate('literature')}
                className="bg-slate-50 p-6 rounded-3xl border border-slate-200 hover:border-brand-blue/40 transition-all cursor-pointer group shadow-sm"
              >
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-8 h-8 rounded-xl bg-brand-blue/10 text-brand-blue flex items-center justify-center group-hover:bg-brand-blue group-hover:text-white transition-all">
                    <BookOpen size={16} />
                  </div>
                  <h4 className="text-slate-900 font-bold text-base group-hover:text-brand-blue transition-colors underline decoration-brand-blue/40 underline-offset-4">
                    {b.name}
                  </h4>
                </div>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-white shadow-md p-8 md:p-12 rounded-[40px] border border-slate-100 text-center relative overflow-hidden"
        >
          <span className="text-[10px] uppercase tracking-[4px] text-brand-blue font-bold">Our Purpose</span>
          <h2 className="font-display text-3xl md:text-4xl text-slate-900 mt-2 mb-8">
            Our Mission & Vision
          </h2>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-4">
            <button
              ...
              className="px-8 py-4 bg-brand-blue/10 border border-brand-blue/30 text-brand-blue rounded-full text-xs uppercase tracking-widest font-bold hover:bg-brand-blue hover:text-white transition-all"
            >
