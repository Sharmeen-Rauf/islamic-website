  ...
  return (
    <div className="pt-32 pb-24 bg-slate-950 min-h-screen relative overflow-hidden text-slate-300">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-25">
        <div className="absolute top-[10%] left-[15%] w-[500px] h-[500px] rounded-full bg-brand-green/20 blur-[150px]" />
        <div className="absolute top-[50%] right-[10%] w-[600px] h-[600px] rounded-full bg-brand-gold/20 blur-[150px]" />
        <div className="absolute bottom-[5%] left-[20%] w-[500px] h-[500px] rounded-full bg-brand-pink/20 blur-[150px]" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 glass px-6 py-2 rounded-full text-xs uppercase tracking-[4px] text-brand-green font-bold mb-6 border border-brand-green/20"
          >
          ...
          >
            75th Annual Urs Mubarak of <span className="text-brand-green">Imam Hussain (A.S.)</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-3 glass p-6 rounded-3xl border border-white/10 space-y-2">
            <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-[4px] mb-4 border-b border-white/10 pb-2 px-4">
              Archive Years
            </h3>
            {years.map((y) => (
              <button
            ...
            {selectedYear === '2025' ? (
              <>
                ...
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="glass-dark p-8 md:p-12 rounded-[34px] border border-brand-green/30 bg-gradient-to-r from-brand-green/10 via-transparent to-brand-green/5 shadow-2xl relative"
                >
                  <div className="flex flex-wrap items-center justify-between gap-4 mb-6 pb-6 border-b border-white/10">
                    <div>
                      <span className="text-[10px] uppercase tracking-[4px] text-brand-green font-bold block mb-1">
                    ...
                    <div className="glass px-4 py-2 rounded-xl text-xs uppercase tracking-widest text-brand-green font-bold flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div className="glass p-4 rounded-2xl border border-white/5 flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-white font-bold text-sm">Mehfil-e-Shabina</h4>
                        <p className="text-xs text-slate-400 font-serif">9th Muharram, after Isha prayers</p>
                      </div>
                    </div>
                    <div className="glass p-4 rounded-2xl border border-white/5 flex items-center gap-3">
                      <Sparkles className="text-brand-green shrink-0" size={20} />
                      <div>
                        <h4 className="text-white font-bold text-sm">Main Urs Gathering</h4>
                        <p className="text-xs text-slate-400 font-serif">10th Muharram, starting at 10:00 AM</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 bg-white/5 rounded-2xl space-y-3 mb-8 border border-white/10 font-serif text-sm">
                    <p className="flex items-center gap-2 text-white">
                      <span className="text-brand-green font-bold">✨ Special Naat Recitation:</span> Al-Haaj Muhammad Shehbaz Qamar Fareedi
                    </p>
                    <p className="flex items-center gap-2 text-white">
                      <span className="text-brand-green font-bold">🎙️ Special Address:</span> Allama Sahibzada Abid Hussain Shakoori Al-Hussaini
                    </p>
                  </div>

                  <div className="pt-6 border-t border-white/10 flex flex-wrap items-center justify-between gap-4 text-xs font-bold uppercase tracking-widest">
                    <div className="flex items-center gap-2 text-slate-300">
                      <Phone size={16} className="text-brand-green" /> Contact: 0333-5006899
                    </div>
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="glass-dark p-8 md:p-12 rounded-[34px] border border-white/10 shadow-2xl relative"
                >
                  <div className="flex flex-wrap items-center justify-between gap-4 mb-6 pb-6 border-b border-white/10">
                    <div>
                      <span className="text-[10px] uppercase tracking-[4px] text-brand-gold font-bold block mb-1">
                        Ceremony Itinerary
                      </span>
                      <h2 className="font-display text-2xl md:text-3xl text-white">
                    ...
                    <div className="glass px-4 py-2 rounded-xl text-xs uppercase tracking-widest text-slate-400 font-bold">
                      July 5, 2025 (09 Muharram)
                    </div>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                    <div className="md:col-span-7 space-y-6 font-serif text-base md:text-lg leading-relaxed text-slate-300">
                      <p>
                    ...
                    <div className="md:col-span-5 w-full">
                      <div className="aspect-[4/3] rounded-3xl overflow-hidden glass p-2 border border-white/10 shadow-2xl">
                        <img 
                ...
                >
                  <div className="flex flex-wrap items-center justify-between gap-4 mb-6 pb-6 border-b border-white/10">
                    <div>
                      <span className="text-[10px] uppercase tracking-[4px] text-brand-pink font-bold block mb-1">
                  ...
                  <p className="font-serif text-lg leading-relaxed text-slate-300 mb-10">
                  ...
                  <div className="space-y-12">
                    <div className="p-8 glass rounded-3xl border border-white/5 bg-gradient-to-r from-white/5 to-transparent">
                      <h3 className="font-display text-xl text-white mb-4 flex items-center gap-2">
                        <Sparkles className="text-brand-green" size={20} /> Exalted Status of Ahlul Bayt (The Holy Household)
                      </h3>
                      ...
                      <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 font-serif text-white font-bold text-sm bg-black/30 p-6 rounded-2xl border border-white/5">
                        <li className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-brand-green" /> The Holy Prophet Muhammad ﷺ</li>
                        <li className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-brand-green" /> Hazrat Ali (R.A.)</li>
                        <li className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-brand-green" /> Hazrat Fatima-tuz-Zahra (A.S.)</li>
                        <li className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-brand-green" /> Hazrat Imam Hassan (A.S.)</li>
                        <li className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-brand-green" /> Hazrat Imam Hussain (A.S.)</li>
                      </ul>
                      <p className="font-serif text-xs text-slate-400 mt-3 italic">
                    ...
                    <div className="p-8 glass rounded-3xl border border-white/5 bg-gradient-to-r from-white/5 to-transparent">
                      <h3 className="font-display text-xl text-white mb-4 flex items-center gap-2">
                        <BookOpen className="text-brand-gold" size={20} /> Quranic References and Grammatical Insights
                      </h3>
                      <p className="font-serif text-slate-300 leading-relaxed mb-4">
                      ...
                      <div className="p-6 bg-slate-900/80 rounded-2xl border border-white/10 mb-4 text-center">
                        <p className="font-arabic text-xl md:text-2xl text-brand-gold leading-relaxed mb-4">
                    ...
                    <div className="p-8 glass rounded-3xl border border-white/5 bg-gradient-to-r from-white/5 to-transparent">
                      ...
                      <ul className="space-y-2 font-serif text-white font-bold text-sm pl-4 border-l-2 border-brand-pink mb-4">
                    ...
                    <div className="p-8 glass rounded-3xl border border-white/5 bg-gradient-to-r from-white/5 to-transparent">
                      ...
                      <div className="p-6 bg-brand-green/10 rounded-2xl border border-brand-green/30 mt-6">
                        <h4 className="text-white font-bold text-sm uppercase tracking-widest mb-2 text-brand-green">
              ...
              <div className="glass-dark p-16 rounded-[40px] border border-white/10 text-center">
                <Calendar className="mx-auto mb-4 text-brand-green" size={48} />
                <h2 className="font-display text-3xl text-white mb-4">
                  Archive for {selectedYear} Urs Mubarak
                </h2>
                <p className="font-serif text-slate-400 max-w-xl mx-auto leading-relaxed">
